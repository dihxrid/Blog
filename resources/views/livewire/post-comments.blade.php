<div class="pt-10 mt-10 border-t border-gray-100 comments-box">
    <h2 class="mb-5 text-2xl font-semibold text-gray-900">Bình luận</h2>
    @auth
    ...
    @else
        <a wire:navigate class="py-1 text-yellow-500 underline" href="{{ route('login') }}"> Đăng nhập để bình luận</a>
    @endauth
    <div class="px-3 py-2 mt-5 user-comments">
        ...
        @empty
            <div class="text-center text-gray-500">
                <span> Không có bình luận nào được đăng</span>
            </div>
        @endforelse
    </div>
    <div class="my-2">
